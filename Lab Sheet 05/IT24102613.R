...
attach(Delivery_Times)
fix(Delivery_Times)
histogram<-hist(D_Time,main="Histogram for deliver times",
                breaks = seq(20, 70,length = 10),right = FALSE)

#Q3
#(Most of the data is at the low end, forming a peak on the left 
# and a few high values stretch the graph out to the right.)
